...
def create_unit_list(cur,con):
    ...
    cur.execute('CREATE DATABASE unit_list_datachempy;')
    cur.execute('CREATE TABLE unit_list_datachempy.Main(`id` INT NOT NULL AUTO_INCREMENT, `unit_str` VARCHAR(10000) DEFAULT \'NONE\', PRIMARY KEY (`id`));')
